...
export default function GasPriceScreenCA({ changeCountry } : any) {
  ...
  const fetchGasPrices = useCallback(async () => {
    ...
    try {
      ...
      const gasPricesResponse = await fetchData(`/gas-prices?country=CA&region=${region ?? ''}`, !globalState['Enable Requests']);
    ...
    <Page>
      <View style={styles.main}>
        ...
        <SegmentedButtons
          ...
          onValueChange={(value) => value === 'USA' && changeCountry()}
          value="Canada"
        />
      </View>
    </Page>
